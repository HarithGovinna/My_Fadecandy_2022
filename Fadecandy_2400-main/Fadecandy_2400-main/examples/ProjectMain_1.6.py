...
class AnimationBox:
    def __init__(self, root):          
        ...
        img = img.resize((165,165), Image.ANTIALIAS)     #Size of the image
        ...
        Buttonframe=Frame(self.root,bd=20,relief=RIDGE)             #Create button frame
        ...
        btnCovid.grid(row=0,column=1)                                                                                                                    #Position and the size of the button
