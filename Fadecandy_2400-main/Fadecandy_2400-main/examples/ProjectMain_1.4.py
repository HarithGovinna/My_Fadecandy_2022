...
class AnimationBox:
    def __init__(self, root):
        ...
        Buttonframe.place(x=330,y=385,width=165,height=145)

        btnExit=Button(Buttonframe , command= self.Covid, text="Test Me" ,fg="white",bg="green",font=("times new romen",12,"bold"),width=12,height=5)
